        ...
        <ul class="nav">
          ...
          <li class="active ">
            <a href="./Owner.employee.php">
              <i class="now-ui-icons location_map-big" style="color:black"></i>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Employee</a>
          </div>
            ...
            <div class="content">
                <div class="row">
                            ...
                            <div class="card-body all-icons">
                                <div class="row">
                                    <table class="table table-striped" style="width: 100%">
                                        <tr>
                                            <thead>
                                                <th scope="col" style="text-align:center;">Id.พนักงาน</th>
                                                ...
                                                <th scope="col" style="text-align:center;">บัตรประชาชน</th>
                                                ...
                                                <?php
                  $query = "SELECT * FROM login l INNER JOIN  Priority p ON p.IdPrio = l.Priority WHERE Priority = '2' OR Priority = '3'";
                  $rs = $conn->query($query);
                  ...
                  echo  "<tbody id=\"myTable\">".
                        ...
                        "<td style=\"text-align:center\">".$row["NamePrio"]."</td>".
                        "<td style=\"text-align:center\">".$row["IDcard"]."</td>".
