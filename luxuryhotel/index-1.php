...
<body>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5"
        style="background-image: url(images/DEPT-TheMIST-1.jpg);">
            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    <div class="heading-wrap text-center element-animate">
                        <h4 class="sub-heading" style="font-size: 24px;">Palace Hotel</h4>

                        <h2 class="heading" style="font-size: 20px">Relax and Enjoy</h2>

                        <p class="mb-5">
                            Come by love , Stay with please , Leave with obsess <br />

                            Grand hotel and hot spring OUT OF THE
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-12 heading-wrap text-center">
                    <h4 class="sub-heading">Palace Capsule</h4>

                    <h2 class="heading">Preview Rooms</h2>
                </div>
            </div>
                    ...
                    <div class="media d-block room mb-0">
                        ...
                        <div class="media-body">
                            ...
                            <p>
                                ...
                                <i class="fas fa-hamburger"></i> Free breakfast, lounge-vip , free dinner on loof-top
                                hotel<br>
                                ...
                                <i class="fa fa-eye" style="font-size:18px; color:green"></i> View : Nature <br>
                            </p>
